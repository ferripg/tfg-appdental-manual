...
-- AddForeignKey
ALTER TABLE "Despesa" ADD CONSTRAINT "Despesa_proveidorId_fkey" FOREIGN KEY ("proveidorId") REFERENCES "Proveidor"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
